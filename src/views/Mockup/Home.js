        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <Link to="/" className="flex items-center space-x-2 text-gray-700 hover:text-blue-600 transition">
              ...
              <span className="text-2xl font-normal text-grey-500 tracking-widest">Guerrmo</span>
            </Link>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl font-bold mb-6">
                Qué pieza estas buscando?
              </h1>
              <p className="text-xl mb-1 font-bold">
                Solicita tus productos en línea y recibelos en tu domicilio.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Servicio personalizado en Ciudad Juárez con años de experiencia</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-3xl">🚚</span>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="relative">
              <div className="bg-white rounded-xl p-8 shadow-sm">
                ...
                <h3 className="font-bold text-xl mb-3">Recibe confirmación</h3>
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white mb-8">
            Atendemos toda la zona metropolitana: Centro, Juriquilla, El Refugio, Corregidora y más
          </p>
          <Link to="/catalogo" className="inline-block bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl p-6 border-2 border-blue-200">
